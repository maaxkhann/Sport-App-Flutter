            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    homeButton(
                        () {}, const Color(0xff1566C9), 'Home', kHeading55),
                    homeButton(
                        () {},
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    homeButton(() {}, const Color(0xff1566C9), 'View Seat',
                        kHeading55),
                    homeButton(
                        () {},
                        const Color(0xff8F90A6),
      ...
      child: Center(
        child: Padding(
          ...
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Text('Adult 60+', style: kHeading6),
              Row(
                children: [
                  GestureDetector(
                    onTap: () {
